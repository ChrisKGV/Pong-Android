...
public class PongThread extends Thread {
    ...
    private static final int PHYS_BALL_SPEED = 10; //8
    private static final int PHYS_PADDLE_SPEED = 12;
    private static final int PHYS_FPS = 60;
    private static final double PHYS_MAX_BOUNCE_ANGLE = 5 * Math.PI / 12;
    ...
    private void handleHit(Player player) {
        if (player.collision > 0) {
            player.paint.setShadowLayer(10, 0, 0, Color.RED);
        } else {
